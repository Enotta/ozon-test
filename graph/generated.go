...
type ComplexityRoot struct {
	...
	Query struct {
		Comments func(childComplexity int, postID string, parentID *string) int
...
type QueryResolver interface {
	...
	Comments(ctx context.Context, postID string, parentID *string) ([]*model.Comment, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.comments":
		...
		return e.complexity.Query.Comments(childComplexity, args["postId"].(string), args["parentId"].(*string)), true
...
func (ec *executionContext) field_Mutation_createAuthor_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewAuthor2ozonᚑtestᚋgraphᚋmodelᚐNewAuthor(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createComment_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewComment2ozonᚑtestᚋgraphᚋmodelᚐNewComment(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createPost_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewPost2ozonᚑtestᚋgraphᚋmodelᚐNewPost(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createAuthor(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAuthor2ᚖozonᚑtestᚋgraphᚋmodelᚐAuthor(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_comments(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Comments(rctx, fc.Args["postId"].(string), fc.Args["parentId"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*model.Comment)
	fc.Result = res
	return ec.marshalNComment2ᚕᚖozonᚑtestᚋgraphᚋmodelᚐCommentᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewComment(ctx context.Context, obj any) (model.NewComment, error) {
	...
	fieldsInOrder := [...]string{"content", "author", "postId", "parentId"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) marshalNAuthor2ozonᚑtestᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v model.Author) graphql.Marshaler {
	return ec._Author(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthor2ᚖozonᚑtestᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v *model.Author) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNComment2ᚕᚖozonᚑtestᚋgraphᚋmodelᚐCommentᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Comment) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNComment2ᚖozonᚑtestᚋgraphᚋmodelᚐComment(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalNNewAuthor2ozonᚑtestᚋgraphᚋmodelᚐNewAuthor(ctx context.Context, v any) (model.NewAuthor, error) {
	res, err := ec.unmarshalInputNewAuthor(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewComment2ozonᚑtestᚋgraphᚋmodelᚐNewComment(ctx context.Context, v any) (model.NewComment, error) {
	res, err := ec.unmarshalInputNewComment(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewPost2ozonᚑtestᚋgraphᚋmodelᚐNewPost(ctx context.Context, v any) (model.NewPost, error) {
